...
<table class='table table-bordered' id='TabelTambahBarang' class='table-responsive'>
	<thead>
		<tr>
			<th>#</th>
			<th>Kode</th>
...
function BarisBaru()
{
	...
	Baris += "<td><input type='text' name='nama[]' class='form-control input-sm' size='50'></td>";
	Baris += "<td>";
	Baris += "<select name='gender[]' class='form-control input-sm' style='width:85;'>";
	Baris += "<option value='Lak-laki'>L</option>";
	Baris += "<option value='Perempuan'>P</option>";
	Baris += "</select>";
	Baris += "</td>";
	Baris += "<td>";
	Baris += "<select name='id_kategori_barang[]' class='form-control input-sm' style='width:85;'>";
	...
	Baris += "<select name='id_merk_barang[]' class='form-control input-sm' style='width:75px;'>";
	Baris += "<option value=''></option>";
	...
	Baris += "<select name='warna_barang[]' class='form-control input-sm' style='width:70px;'>";
	Baris += "<option value=''></option>";
	
	<?php 
	if($warna->num_rows() > 0)
	{
		foreach($warna->result() as $w) { ?>
			Baris += "<option value='<?php echo $w->id_warna_barang; ?>'><?php echo $w->warna; ?></option>";
		<?php }
	}
	?>
	...
	Baris += "<select name='rak[]' class='form-control input-sm' style='width:70px;'>";
	Baris += "<option value=''></option>";
	...
	if($rak->num_rows() > 0)
	{
		foreach($rak->result() as $r) { ?>
			Baris += "<option value='<?php echo $r->id_rak_barang; ?>'><?php echo $r->rak; ?></option>";
		<?php }
	}
	?>
	...
	Baris += "</select>";
	Baris += "</td>";
	Baris += "<td><input type='text' name='harga[]' class='form-control input-sm' onkeypress='return check_int(event)' size='50'></td>";
