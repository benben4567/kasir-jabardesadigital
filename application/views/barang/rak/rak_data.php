...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Barang <i class='fa fa-angle-right fa-fw'></i> Display Rak</h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('barang/tambah-rak')."' class='btn btn-default' id='TambahRak'><i class='fa fa-plus fa-fw'></i> Tambah Rak</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('barang/list-rak-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
