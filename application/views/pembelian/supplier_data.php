...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-shopping-cart fa-fw'></i> Pembelian <i class='fa fa-angle-right fa-fw'></i> Data Supplier</h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('pembelian/tambah-supplier')."' class='btn btn-default' id='TambahSupplier'><i class='fa fa-plus fa-fw'></i> Tambah</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('pembelian/supplier-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
	...
	$(document).on('click', '#HapusSupplier', function(e){
		e.preventDefault();
		...
		$('#ModalFooter').html("<button type='button' class='btn btn-primary' id='YesDeleteSupplier' data-url='"+Link+"'>Ya, saya yakin</button><button type='button' class='btn btn-default' data-dismiss='modal'>Batal</button>");
		$('#ModalGue').modal('show');
	});
