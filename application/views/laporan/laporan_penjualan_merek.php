<?php if($penjualan->num_rows() > 0) { ?>
	...
	<p>
		...
		?>
		<a href="<?php echo site_url('laporanmerek/pdf/'.$from.'/'.$to.'/'.$merek); ?>" target='blank' class='btn btn-default'><img src="<?php echo config_item('img'); ?>pdf.png"> Export ke PDF</a>
		<a href="<?php echo site_url('laporanmerek/excel/'.$from.'/'.$to.'/'.$merek); ?>" target='blank' class='btn btn-default'><img src="<?php echo config_item('img'); ?>xls.png"> Export ke Excel</a>
	</p>
	<br />
<?php } ?>
