...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan by Gender</h5>
			<hr />
			...
			<div class="row">
				...
				<div class="col-sm-5">
					<div class="form-horizontal">
						<div class="form-group">
								<label class="col-sm-4 control-label">Nomor Rak</label>
								<div class="col-sm-8">
							 <select id='rak' name='rak' class="form-control">
        <option value=''>-- Rak --</option>
        <?php 
        foreach($rak as $rakjual){
          echo "<option value='".$rakjual."'>".$rakjual."</option>";
        }
        ?>
      </select>
						</div></div>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporangender/penjualan'); ?>/" + TanggalDari + "/" + TanggalSampai + "/" + Rak + "/" + Gender + "/" + Warna;
			$('#result').load(URL);
		}
	});
});
