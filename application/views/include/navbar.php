	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown <?php if($controller == 'pembelian') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class='fa fa-arrow-circle-o-down fa-fw'></i> Pembelian <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<?php if($level !== 'keuangan'){ ?>
						<li><a href="<?php echo site_url('pembelian/transaksi'); ?>">Transaksi</a></li>
						<?php } ?>
						
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo site_url('pembelian/supplier'); ?>">Data Supplier</a></li>
					</ul>
				</li>
				<?php } ?>
				<li class="dropdown <?php if($controller == 'barang') { echo 'active'; } ?>">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="<?php echo site_url('barang/list-warna'); ?>">List Warna</a></li>
					</ul>
				</li>
<li class="dropdown <?php if($controller == 'rak') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class='fa fa-cube fa-fw'></i> Inventory Rak <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url('rak/list-rak'); ?>">List Rak</a></li>
							<li><a href="<?php echo site_url('rak/list-display-rak'); ?>">List Display Rak</a></li>
...
<li class="dropdown <?php if($controller == 'laporan') { echo 'active'; } ?>">
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url('laporan'); ?>">Laporan</a></li>
							<li><a href="<?php echo site_url('laporangender'); ?>">Laporan Gender</a></li>
								<li><a href="<?php echo site_url('laporanmerek'); ?>">Laporan Merek</a></li>
								<li><a href="<?php echo site_url('laporanrak'); ?>">Laporan Rak</a></li>
					</ul>
